/*
 * Overrides the original types as they are not updates
...
declare module "@nivo/line" {
  ...
  export interface LineCustomLayerProps
    extends Omit<LineSvgProps, "xScale" | "yScale"> {
    xScale: ScaleFunc;
    yScale: ScaleFunc;
  }

  export type DataFormatter = (value: LineValue) => string | number;
  export type LineCustomLayer = (
    props: LineCustomLayerProps
  ) => React.ReactNode;
  ...
  export interface LineProps {
    ...
    onMouseEnter?: (point, event) => void;
    onMouseLeave?: (point, event) => void;
